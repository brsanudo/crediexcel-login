...
const Navbar = () => {
  ...
  const classButtonPurple =
    "text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3  dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800";
